...
<%
	...
	System.out.println("add_customer3="+pan_no+","+mobile);
%>
	<form>
		<div class="container">
			<div class="left">
				...
				<ul>
					<li><a href="add_customer3.jsp" id="hat" ><img src="add-blue.png">Add Customer</a></li>
			...
			<div class="right">
				...
				<div class="jar">
					...
					%>
					<div id="each">
						<a href="customer_biodata.jsp" class="biodata">Biodata</a>
					</div>
