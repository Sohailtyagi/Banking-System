		...
		<div class="container">
			<div class="left">
				...
				<ul>
					...
					<li><a href="fd.jsp" id="hat"><img src="deposit-blue.png">Fixed Deposit (FD)</a></li>
				...
				<div class="jar">
					...
					<div class="first">
						...
						<div id="each">
							...
							<input type="text" placeholder="FD Number" name="fd_number" class="fixed">
						</div>
						<div id="each">
							<label>Amount:</label>
						...
						<div id="each">
							...
							<input type="radio" name="radio1" value="yes" class="yes">
							<label>Yes</label>
							<input type="radio" name="radio1" value="no" class="no">
							<label>No</label>
						</div>
						<div id="each">
							<label>Mode of Payment:</label>
							<input type="radio" name="radio2" value="cash" class="cash">
							<label>Cash</label>
							<input type="radio" name="radio2" value="acc" class="acc">
							<label>Account</label>
						</div>
						<div id="each">
