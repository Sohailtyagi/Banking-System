...
<%
	...
	System.out.println("add_customer2="+pan_no+","+mobile);
%>
	<form>
		<div class="container">
			<div class="left">
				...
				<ul>
					<li><a href="add_customer2.jsp" id="hat" ><img src="add-blue.png">Add Customer</a></li>
			...
			<div class="right">
				...
				<div class="jar">
					...
					<% 
						session.setAttribute("nap", pan_no);
						session.setAttribute("mobile", mobile);
					%>
					<div id="each">
						<a href="additional_details.jsp" class="additional">Additional Details</a>
					</div>
					<div id="each">
